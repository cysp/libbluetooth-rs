...
use super::opcode::{self,HciOpcode,HciControllerOpcode};
...
pub trait HciCommandBuilderAddParameter<T> {
...
impl HciCommandBuilderAddParameter<u8> for HciCommandBuilder {
...
impl HciCommandBuilderAddParameter<u16> for HciCommandBuilder {
...
impl<'a> HciCommandBuilderAddParameter<&'a [u8]> for HciCommandBuilder {
...
mod tests {
	use super::*;
	use super::super::opcode::HciOpcode;
	use super::super::opcode::HciControllerOpcode;
	#[test]
	pub fn test_builder_1() {
